...
<header class="bg-charcoal-200 text-silver-200">
	<nav class="border-b border-charcoal-100 max-[420px]:justify-center">
		<section
			class="xl:container mx-auto flex items-center justify-between max-[420px]:justify-center"
		>
			<a href="/" class="py-6">
				<svg
					width="99"
									...
									{#if isBookmarked}
										<button
											onclick={async (e: MouseEvent) => {
												...
												if (typeof local_indexDB_id === 'number')
				...
				<section in:fly={{ duration: 800, y: 112 }} class="flex flex-col items-center gap-6 mt-14">
					<div>
						...
						>
							...
							/>
							<path
								d="M158.333 75.527V153.154C158.333 163.062 151.227 167.23 142.548 162.447L115.693 147.482C112.823 145.91 108.177 145.91 105.307 147.482L78.4517 162.447C69.7733 167.23 62.6667 163.062 62.6667 153.154V75.527C62.6667 63.842 72.2333 54.2754 83.9183 54.2754H137.082C148.767 54.2754 158.333 63.842 158.333 75.527Z"
								fill="white"
							/>
							<path
								d="M199.333 49.0143V126.641C199.333 136.549 192.227 140.718 183.548 135.934L158.333 121.858V75.5276C158.333 63.8426 148.767 54.2761 137.082 54.2761H103.667V49.0143C103.667 37.3293 113.233 27.7627 124.918 27.7627H178.082C189.767 27.7627 199.333 37.3293 199.333 49.0143Z"
								fill="#88F32B"
								fill-opacity="0.5"
							/>
							<path
								d="M124.167 90.9704H115.625V82.4287C115.625 79.627 113.302 77.3037 110.5 77.3037C107.698 77.3037 105.375 79.627 105.375 82.4287V90.9704H96.8333C94.0317 90.9704 91.7083 93.2937 91.7083 96.0954C91.7083 98.897 94.0317 101.22 96.8333 101.22H105.375V109.762C105.375 112.564 107.698 114.887 110.5 114.887C113.302 114.887 115.625 112.564 115.625 109.762V101.22H124.167C126.968 101.22 129.292 98.897 129.292 96.0954C129.292 93.2937 126.968 90.9704 124.167 90.9704Z"
								fill="black"
								fill-opacity="0.2"
							/>
