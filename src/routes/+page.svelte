...
<header class="  bg-charcoal-200 text-silver-200 h-screen">
    <section class="xl:container mx-auto h-full flex flex-col justify-between">
        ...
        <div class="flex flex-col items-center gap-6">
            <h1 class=" text-6xl/snug text-silver-100 max-w-xl text-center mx-auto">Land Your Dream Tech
                Job. Start
                Searching Now.</h1>
            <a href="/" class=" text-silver-100 border border-charcoal-100 py-4 px-12 w-fit">EXPLORE</a>
        </div>

        <section class=" w-full border-y border-charcoal-100 flex justify-between">
